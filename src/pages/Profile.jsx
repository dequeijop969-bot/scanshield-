    ...
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-10 sm:py-16">
      ...
      >
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl sm:text-4xl font-black tracking-tighter text-foreground mb-2 text-balance">Meu Perfil</h1>
        ...
        >
          <div className="relative">
            <div className="w-20 h-20 rounded-2xl bg-card border border-border flex items-center justify-center">
              <UserCircle2 className="w-11 h-11 text-foreground/80" strokeWidth={1.5} />
            </div>
