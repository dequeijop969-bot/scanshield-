...
import { CheckCircle2, Zap, Shield, Brain, MessageCircle, ScanSearch, Loader2, XCircle, Diamond, GraduationCap, X, Check, Link2, Video, Lock } from "lucide-react";
...
export default function Premium() {
  ...
  return (
    <div className="min-h-screen bg-background px-4 py-16">
      ...
      {/* Plans grid */}
      <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mt-4">
        {/* Free plan card */}
        <motion.div
        ...
        >
          <div className="mb-6">
            <h2 className="text-xl font-black text-foreground mb-1">{FREE_PLAN.name}</h2>
