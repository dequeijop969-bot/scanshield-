  ...
  if (!canUseVideo && !freeTrialUsed) {
    return (
      <motion.div
        ...
        animate={{ opacity: 1, scale: 1 }}
        transition={{ duration: 0.4 }}
        className="relative rounded-2xl border-2 border-dashed border-yellow-400/40 bg-card/50 overflow-hidden"
      >
        <motion.div
          className="absolute inset-0 bg-gradient-to-br from-yellow-400/[0.05] to-transparent pointer-events-none"
