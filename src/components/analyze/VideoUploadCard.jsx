...
export default function VideoUploadCard({
  ...
  if (!canUseVideo) {
    return (
      <div className="relative rounded-2xl border-2 border-dashed border-border bg-card/50 p-8 sm:p-10 text-center overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-yellow-400/[0.03] to-transparent pointer-events-none" />
