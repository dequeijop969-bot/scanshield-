...
const plans = [
  {
    ...
    analyses: 10,
    features: ["10 análises/mês", "5 dúvidas com assistente", "Análise de golpes e fraudes"],
  },
  {
    key: "intermediario",
    name: "Intermediário",
    ...
    analyses: 20,
    features: ["20 análises/mês", "8 dúvidas com assistente", "Análise de golpes e fraudes", "Detecção de deepfake"],
  },
  {
    key: "pro",
    name: "PRO",
    ...
    analyses: 35,
    features: ["35 análises/mês", "10 dúvidas com assistente", "Análise de golpes e fraudes", "Deepfake avançado", "Resultados prioritários"],
  },
];
