...
Além disso, escreva um "reason" bem curto (máximo 12 palavras, em português) explicando o motivo principal — ex: "Preço muito abaixo do mercado" ou "Link com domínio suspeito" ou "Nenhum sinal de risco encontrado".

RESPONDA APENAS com um objeto JSON válido, sem markdown, sem explicações extras. Schema: {"categories": ["golpe"|"oferta"|"informacao_falsa"|"deepfake"], "primary": "golpe"|"oferta"|"informacao_falsa"|"deepfake"|"geral", "reason": "string curta"}`;
